...
class MosaicCollectionViewLayout: UICollectionViewFlowLayout {
  ...
  required override init() {
    ...
    self.columnSpacing = 0.0
    self.headerHeight = 44.0 //viewcontroller
    self._sectionInset = UIEdgeInsets.init(top: 0.0, left: 0.0, bottom: 0.0, right: 0.0)
    self.interItemSpacing = UIEdgeInsets.init(top: 0.0, left: 0, bottom: 0.0, right: 0)
    super.init()
