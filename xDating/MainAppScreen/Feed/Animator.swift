...
final class Animator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    private let firstViewController: MainAppViewController
    private let secondViewController: PreviewViewController
    ...
    // 10
    init?(type: PresentationType, firstViewController: MainAppViewController, secondViewController: PreviewViewController, selectedCellImageViewSnapshot: UIView) {
        self.type = type
        ...
        // 11
        self.cellImageViewRect = selectedCell.imageNode.view.convert(selectedCell.imageNode.view.bounds, to: window)
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        guard
            ...
            let cellImageSnapshot = selectedCell.imageNode.view.snapshotView(afterScreenUpdates: true),
