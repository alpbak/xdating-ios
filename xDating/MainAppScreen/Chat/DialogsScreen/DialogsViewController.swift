...
class DialogsViewController: UITableViewController {
    ...
    private func hasConnectivity() -> Bool {
        ...
        guard status != NetworkConnectionStatus.notConnection else {
            ...
            displayAlert(alertTitle: LoginConstant.checkInternet, alertMessage: LoginConstant.checkInternetMessage, parent: self)
            return false
        }
        return true
    }
...
//    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "DialogCellNew",
                                                       for: indexPath) as? DialogCellNew else {
